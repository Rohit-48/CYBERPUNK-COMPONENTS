  ...
  return (
    <div className="flex flex-col items-center text-center mt-10 p-4 selection:bg-yellow-300 font-family-electrolize">
        ...
        <div className="flex items-center justify-center gap-6 mt-1">
            <button className="bg-yellow-400  text-white px-4 py-2 rounded-md cursor-pointer hover:bg-yellow-400 transform duration-300 hover:-translate-y-0.5 hover:scale-105">Get Started</button>
